    ...
    <div className="page">
      ...
      {tab === "shows" && (
        <div>
          ...
          {shows.length === 0 && (
            <p style={{ color: "var(--muted)" }}>No shows created yet.</p>
          )}
          {shows.map((s) => (
              ...
              {tab === `revenue-${s._id}` && revenue && (
                ...
                >
                  {loadingRevenue ? (
                    ...
                    <>
                      <p>
                        Bookings: <b>{revenue.bookingsCount}</b>
                      </p>
                      <p>
                        Revenue: <b>₹{revenue.totalRevenue}</b>
                      </p>
          ...
          >
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setShowForm({ ...showForm, eventId: e.target.value })
                }
                required
              >
            ...
            {selectedVenue?.seatLayout.map((bl) => (
              <div className="form-group" key={bl.category}>
                ...
                <input
                  type="number"
                  min={0}
                  value={showForm[`price_${bl.category}`] || ""}
                  onChange={(e) =>
                    setShowForm({
                      ...showForm,
                      [`price_${bl.category}`]: e.target.value,
                    })
                  }
                  required
                />
